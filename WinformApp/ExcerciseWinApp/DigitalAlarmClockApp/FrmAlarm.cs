...
namespace DigitalAlarmClockApp
{
    public partial class FrmAlarm : Form
    {
        ...
        private void MyTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (IsSetAlarm == true) // 알람설정이 된다면
            {
                //알람 시간하고 현재 시간 일치하면 알람울리기
                if (SetDay == DateTime.Today && SetTime.Hour == curDate.Hour && SetTime.Minute == curDate.Minute && SetTime.Second == curDate.Second)
                {
                    ...
                    MessageBox.Show("마 일나라!!!", "알람", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
